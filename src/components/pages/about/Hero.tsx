...
export const AboutHero = () => {
  return (
    <div className={"w-full relative h-[800px] md:h-max pt-12 overflow-hidden"}>
      {/* Background */}
      ...
      <div className="w-[90%] max-w-5xl mx-auto flex flex-col gap-10 items-center relative z-10">
        <h1 className="font-eudoxus-bold text-[98px] py-5 px-2 text-white text-center">
          About Us
        </h1>

        <p className="text-[#BEC0CA] font-inter font-medium text-xl max-w-3xl text-center">
